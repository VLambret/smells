...
backlog = [
    ...
    Direction('Rust basics',
              items=[Item(id='RB1', label='Helloworld', done=True),
                     ...
                     Item(id='RB4', label='print branch name using git lib'),
                     Item(id='RB5', label='print HEAD meta-data (author, title, date'),
                     Item(id='RB6', label='git log --oneline'),
                     ]),
    Direction('Unit Tests',
              items=[
                  ...
                  Item(id='UT4', label='Setup/TearDown'),
                  Item(id='UT5', label='Mock internal functions'),
                  Item(id='UT6', label='Mock system calls'),
                  ]),
    Direction('E2E Tests',
              items=[
                  Item(id='E2ET1', label='End to End tests'),
                  Item(id='E2ET2', label='BDD tests'),
                  ]),
    Direction('Tools',
              items=[
                  ...
                  Item(id='TOOL4', label='Performances'),
                  ]),
    Direction('Packaging',
              items=[
                  Item(id='PACKAGE0', label='Semantic Release'),
                  Item(id='PACKAGE1', label='Linux'),
                  Item(id='PACKAGE2', label='Windows'),
                  Item(id='PACKAGE3', label='Mac'),
                  ]),
    Direction('CI',
              items=[
                  Item(id='CI1', label='Compilation'),
                  Item(id='CI2', label='Tests', dependencies='UT1'),
                  Item(id='CI3', label='E2E Tests', dependencies='E2ET1'),
                  ...
                  Item(id='CI7', label='Notifications'),
                  ]),
    ...
    Direction('Size Analysis',
              items=[
                  ...
                  Item(id='SIZE2', label='Compute file size'),
                  Item(id='SIZE3', label='Structured JSON format'),
                  Item(id='SIZE4', label='Directory score'),
                  ]),
    Direction('Social complexity',
              items=[
                  Item(id='SOCIAL1', label='Compute number of authors', dependencies='SIZE4 RB4'),
                  ]),
    Direction('Activity',
              items=[
    ...
    Direction('CLI',
              items=[
                  ...
                  Item(id='CLI2', label='--usage'),
                  Item(id='CLI3', label='--version'),
                  Item(id='CLI4', label='Size', dependencies='SIZE4'),
                  Item(id='CLI5', label='Social complexity', dependencies='SOCIAL1'),
    ...
    Direction('Optimization',
              items=[
                  Item(id='OPTI1', label='Linux-kernel timings', dependencies='TOOL4'),
                  Item(id='OPTI2', label='optimize bottlenecks'),
                  ]),
